...
class Calculator:
    ...
    def create_special_buttons(self):
        ...
        self.create_equals_buttom()
        self.create_square_buttom()
        self.create_sqrt_buttom()
    ...
    def create_clear_buttom(self):
        button = tk.Button(self.buttons_frame, text="C", bg=OFF_WHITE, fg=LABEL_COLOR, font=DIGITS_FONT_STYLE,
                           borderwidth=0,command=self.clear)
        button.grid(row=0, column=1, sticky=tk.NSEW)
    def square(self):
        self.current_expression = str(eval(f"{self.current_expression}**2"))
        self.update_label()
    def create_square_buttom(self):
